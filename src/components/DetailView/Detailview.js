    ...
    render() {
        ...
        <div className="container">
          <div className="row" style={{marginTop:"20px", marginBottom:"20px"}}>
            <div className="col-8">
            <div className="media">
        <OwlCarousel options={options} style={{width:250,height:150,marginRight:"20px",color:"blue"}}>
            <div><img src={item.imageurl1} style={{borderRadius:"5px",zIndex:-100}} className="align-self-start mr-3" alt="..."></img></div>
            <div><img src={item.imageurl2} style={{borderRadius:"5px",zIndex:-100}} className="align-self-start mr-3" alt="..."></img></div>
        </OwlCarousel>
