...
import {TabletListURL} from '../../constants';
    ...
    <div>
        ...
        <div key={product.title} className="col-md-3 col-sm-6">
            ...
            <div className="product-image4">
                <a href="javasript:;" onClick={() => this.props.history.push(`tablets/${product.id}/`)}>
                    <img className="pic-1" src={product.imageurl1} alt="#"></img>
                    
                </a>
                <ul className="social">
                    <li><a href="javasript:;" onClick={() => this.props.history.push(`tablets/${product.id}/`)} producta-tip="Quick View"><i className="fa fa-eye"></i></a></li>
