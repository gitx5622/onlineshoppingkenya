...
import {ElectronicListURL} from '../../constants';
...
<div>
        ...
        <div className="product-image4">
            <a href="javasript:;" onClick={() => this.props.history.push(`electronics/${product.id}/`)}>
                <img className="pic-1" src={product.imageurl1} alt="#"></img>
                
            </a>
            <ul className="social">
                <li><a href="javasript:;" onClick={() => this.props.history.push(`electronics/${product.id}/`)} producta-tip="Quick View"><i className="fa fa-eye"></i></a></li>
